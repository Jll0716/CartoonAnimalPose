...
class CocoKeypoint(data.Dataset):
    def __init__(self,
        ...
        anno_file = f"{dataset}_coco.json"
        ...
        for img_id in img_ids:
            ...
            for ann in anns:
                ...
                if w > 0 and h > 0:
                    ...
                    self.valid_animal_list.append(info)
                    obj_idx += 1

    def __getitem__(self, idx):
        target = copy.deepcopy(self.valid_animal_list[idx])
    ...
    def __len__(self):
        return len(self.valid_animal_list)
...
if __name__ == '__main__':
    ...
    train = CocoKeypoint("./data/animal/", dataset="val")
    print(len(train))
    t = train[0]
    print(t)
